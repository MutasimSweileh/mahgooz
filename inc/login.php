    ...
    <div class="auth-inner py-2">
        ...
        <div class="card mb-0" id="login-card">
            <div class="card-body">
                ...
                <form data-block="#login-card" id="login" class="auth-login-form mt-2" action="<?= getSiteUrl("login") ?>" method="POST" novalidate="novalidate">
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="<?= getSiteUrl("forgot") ?>">
                                <small><?= $_lang["forgot"] ?></small>
                            </a>
                        </div>
                    ...
                    <div class="mb-1">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="remember-me"> <?= $_lang["remember"] ?> </label>
                        </div>
                    </div>
                    <button class="btn btn-primary w-100 waves-effect waves-float waves-light" tabindex="4"><?= $_lang["login"] ?></button>
                </form>

                <p class="text-center mt-2">
                    <span><?= $_lang["new"] ?></span>
                    <a href="<?= getSiteUrl("register") ?>">
                        <span><?= $_lang["create"] ?></span>
                    </a>
                </p>
