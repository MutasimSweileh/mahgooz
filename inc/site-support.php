<div class="content-area-wrapper container-xxl p-0" data-select2-id="11">
                ...
                <div class="email-app-menu">
                    ...
                    <div class="sidebar-menu-list">
                        <div class="list-group list-group-messages">
                            <a href="javascript:;" data-admin="1" data-where="" class="list-group-item list-group-item-action active">
                        ...
                        <div class="list-group list-group-labels">
                            ...
                            <a href="javascript:;" data-where="status=1" class="list-group-item list-group-item-action"><span class="bullet bullet-sm bullet-danger me-1"></span><?= $_lang['Closed'] ?></a>
    ...
    <div class="content-right w-100" data-select2-id="10">
        <div class="content-wrapper container-xxl p-0" data-select2-id="9">
            ...
            <div class="content-body" data-select2-id="8">
                ...
                <div class="email-app-list">
                    ...
                    <div class="app-fixed-search d-flex align-items-center">
                        ...
                        <div class="d-flex align-content-center justify-content-between w-100">
                            ...
                            <button type="button" class="compose-email btn btn-primary text-nowrap waves-effect waves-float waves-light" data-bs-backdrop="false" data-bs-toggle="modal" data-bs-target="#compose-mail">
                                <?= $_lang["Compose"] ?>
                            </button>
                        </div>
                    </div>
                                ...
                                <li class="list-inline-item">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="tag" style="">
                                            <a href="javascript:;" onclick="newFunction2('status=0',1);" class="dropdown-item"><span class="me-50 bullet bullet-success bullet-sm"></span><?= $_lang['Opened'] ?></a>
                                            <a href="javascript:;" onclick="newFunction2('status=1',1);" class="dropdown-item"><span class="me-50 bullet bullet-warning bullet-sm"></span><?= $_lang['Pending'] ?></a>
                                            <a href="javascript:;" onclick="newFunction2('status=2',1);" class="dropdown-item"><span class="me-50 bullet bullet-danger bullet-sm"></span><?= $_lang['Closed'] ?></a>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="email-app-details w-100">
                    ...
                    <div class="email-scroll-area mt-2">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="" data-msg="<?= $_lang['Sentsuccessfully'] ?>" data-callback="newFunction({id},1);" id="support_messages" data-nodata2="true" enctype="multipart/form-data" method="post">
                                ...
                                <form data-red="this" data-msg="<?= $_lang['Sentsuccessfully'] ?>" class="compose-form" id="support">
                                    <div class="compose-mail-form-field select2-primary">
                                        ...
                                        <div class="flex-grow-1">
                                            <select data-select="" name="user_ids[]" class="select2 form-select w-100" id="email-to" multiple>
                                                <? $variable = getUser('login', 'where active=1');
                                                foreach ($variable as $k => $v) { ?>
                                                    <option data-avatar="<?= ($v["avatar"] ? $v["avatar"] : "blank.png") ?>" value="<?= $v["id"] ?>"><?= $v["fullname"] ?></option>
                                                <? } ?>
                                            </select>
                                        </div>
                                    </div>
