                                ...
                                <div class="w-100 p-lg-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <div class="input-group-text p-0">
                                            <input type="number" value="1" placeholder="0" data-TouchSpin min="1" data-validmsg="<?= $_lang["valid"] ?>" id="todoTitleAdd4" name="stock" class="new-todo-item-title form-control" />
                                        </div>
                                    </div>
                                </div>
