<form action="" id="login_table" data-red="this">
    <div class="action-tags">
        ...
        <div class="mb-1">
            ...
            <div class="input-group input-group-merge form-password-toggle">
                <input value="" type="password" class="form-control form-control-merge" id="login-password2" name="password" tabindex="2" placeholder="············" aria-describedby="login-password">
    ...
    <div class="my-1">
        ...
        <button type="button" data-red="this" data-action="remove" data-table="login" class="btn btn-outline-danger ">
            <?= $_lang["delete"] ?>
        </button>
    </div>
</form>