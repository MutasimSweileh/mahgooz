                                                ...
                                                <div class="d-flex product-details-border position-relative pe-0">
                                                    <div class="w-100 p-lg-1 row">
                                                        ...
                                                        <div class="col-md-4 col-12">
                                                            ...
                                                            <input type="text" data-validmsg="<?= $_lang["valid"] ?>" data-icons data-icons id="todoTitleAdd3" name="icon" class="new-todo-item-title form-control" placeholder="<?= $_lang["Icon"] ?>" />
